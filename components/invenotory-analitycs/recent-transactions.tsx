...
const transactions = [
  ...
  { id: 12, name: "Amazon.com", amount: -129.99, date: "2023-07-15", type: "expense" },
  { id: 23, name: "Whole Foods Market", amount: -89.72, date: "2023-07-10", type: "expense" },
  { id: 32, name: "Netflix Subscription", amount: -15.99, date: "2023-07-05", type: "expense" },
  { id: 43, name: "Freelance Payment", amount: 750, date: "2023-07-12", type: "income" },
  { id: 53, name: "Gas Station", amount: -45.5, date: "2023-07-18", type: "expense" },
]
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-xl font-medium">Последние изменения</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          ...
          {transactions.map((transaction) => (
            <div key={transaction.id + "someSF"} className="flex items-center">
